...
class BLECommandServer(object):
    ...
    def __init__(self, redis_server: str = 'localhost') -> None:
        ...
        self.target_service_uuid = '00001523-1212-efde-8282-785fdeadbeef'  # NOTE: replace with your service uuid
        self.example_hw_address = "FF:EE:DE:AD:BE:EF"  # just for reference
...
if __name__ == '__main__':
    ...
    the_server = BLECommandServer("localhost")  # NOTE: replace with your redis IP
